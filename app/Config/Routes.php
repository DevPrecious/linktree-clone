...
$routes->match(['get', 'post'], '/create', 'Home::create', ['filter' => 'auth']);
$routes->match(['get', 'post'], '/edit/(:num)', 'Home::edit/$1', ['filter' => 'auth']);
$routes->match(['get', 'post'],'/del/(:num)', 'Home::delete/$1', ['filter' => 'auth']);
